...
func (h *RefreshTokenHandler) Store(tenantID string, userID string, tokenID string, refreshToken model_auth.RefreshToken) error {
...
func (h *RefreshTokenHandler) GetOne(tenantID string, userID string, tokenID string) (*model_auth.RefreshToken, error) {
...
func (h *RefreshTokenHandler) GetAll(tenantID string, userID string) ([]model_auth.RefreshToken, error) {
...
func (h *RefreshTokenHandler) Validate(tenantID string, userID string, tokenID string) (*model_auth.RefreshToken, error) {
