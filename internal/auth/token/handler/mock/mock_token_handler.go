...
// Source: erp.localhost/internal/auth/token/handler (interfaces: TokenHandler)
//
// Generated by this command:
//
//	mockgen -destination=mock/mock_token_handler.go -package=mock erp.localhost/internal/auth/token/handler TokenHandler
//
