...
type AccessTokenHandler struct {
	keyHandler redis_handler.KeyHandler[auth_cache_models.TokenMetadata]
	tokenIndex *token.TokenIndex
	logger     *logging.Logger
}

// NewAccessTokenHandler creates a new AccessTokenHandler
func NewAccessTokenHandler(keyHandler redis_handler.KeyHandler[auth_cache_models.TokenMetadata], tokenIndex *token.TokenIndex, logger *logging.Logger) *AccessTokenHandler {
	if logger == nil {
	...
	if keyHandler == nil {
		...
		keyHandler = redis_handler.NewBaseKeyHandler[auth_cache_models.TokenMetadata](dbHandler, logger)
	}
