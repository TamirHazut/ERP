...
type RefreshTokenHandler struct {
	keyHandler redis_handler.KeyHandler[auth_models.RefreshToken]
	tokenIndex *token.TokenIndex
	logger     *logging.Logger
}

// NewRefreshTokenHandler creates a new RefreshTokenHandler
func NewRefreshTokenHandler(keyHandler redis_handler.KeyHandler[auth_models.RefreshToken], tokenIndex *token.TokenIndex, logger *logging.Logger) *RefreshTokenHandler {
	if logger == nil {
	...
	if keyHandler == nil {
		...
		keyHandler = redis_handler.NewBaseKeyHandler[auth_models.RefreshToken](dbHandler, logger)
	}
