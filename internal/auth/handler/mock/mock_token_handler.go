...
// Source: erp.localhost/auth/handler (interfaces: TokenHandler)
//
// Generated by this command:
//
//	mockgen -destination=mock/mock_token_handler.go -package=mock erp.localhost/auth/handler TokenHandler
//
