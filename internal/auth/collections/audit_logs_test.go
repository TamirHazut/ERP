...
func TestNewAuditLogsCollection(t *testing.T) {
	...
	mockHandler := mongo_mocks.NewMockCollectionHandler[models.AuditLog](ctrl)
...
func TestAuditLogsCollection_GetAuditLogsByFilter(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			returnError:       nil,
			expectedLogs:      []models.AuditLog{testAuditLog1},
			expectedError:     nil,
			expectedCallTimes: 1,
		},
		{
