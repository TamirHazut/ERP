...
type Error struct {
	...
	Category      ErrorCategory          `protobuf:"varint,3,opt,name=category,proto3,enum=shared.v1.ErrorCategory" json:"category,omitempty"`                                           // Error category for handling
...
const file_shared_proto_rawDesc = "" +
	"\n" +
	"\fshared.proto\x12\tshared.v1\"\xe0\x01\n" +
	"\x05Error\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x124\n" +
	"\bcategory\x18\x03 \x01(\x0e2\x18.shared.v1.ErrorCategoryR\bcategory\x127\n" +
	"\adetails\x18\x04 \x03(\v2\x1d.shared.v1.Error.DetailsEntryR\adetails\x1a:\n" +
	"\fDetailsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"L\n" +
	"\bResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\x02 \x01(\v2\x10.shared.v1.ErrorR\x05error\"D\n" +
	...
	"\x17ERROR_CATEGORY_INTERNAL\x10\x06B1Z/erp.localhost/internal/shared/proto/v1;sharedv1b\x06proto3"
...
var file_shared_proto_goTypes = []any{
	(ErrorCategory)(0),         // 0: shared.v1.ErrorCategory
	(*Error)(nil),              // 1: shared.v1.Error
	(*Response)(nil),           // 2: shared.v1.Response
	(*PaginationRequest)(nil),  // 3: shared.v1.PaginationRequest
	(*PaginationResponse)(nil), // 4: shared.v1.PaginationResponse
	nil,                        // 5: shared.v1.Error.DetailsEntry
}
var file_shared_proto_depIdxs = []int32{
	0, // 0: shared.v1.Error.category:type_name -> shared.v1.ErrorCategory
	5, // 1: shared.v1.Error.details:type_name -> shared.v1.Error.DetailsEntry
	1, // 2: shared.v1.Response.error:type_name -> shared.v1.Error
