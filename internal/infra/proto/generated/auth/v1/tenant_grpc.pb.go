...
const (
	TenantService_CreateTenant_FullMethodName = "/auth.v1.TenantService/CreateTenant"
	TenantService_GetTenant_FullMethodName    = "/auth.v1.TenantService/GetTenant"
	TenantService_GetTenants_FullMethodName   = "/auth.v1.TenantService/GetTenants"
	TenantService_UpdateTenant_FullMethodName = "/auth.v1.TenantService/UpdateTenant"
	TenantService_DeleteTenant_FullMethodName = "/auth.v1.TenantService/DeleteTenant"
)
...
func (c *tenantServiceClient) GetTenants(ctx context.Context, in *GetTenantsRequest, opts ...grpc.CallOption) (*TenantsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedTenantServiceServer) GetTenants(context.Context, *GetTenantsRequest) (*TenantsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTenants not implemented")
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.v1.TenantService",
