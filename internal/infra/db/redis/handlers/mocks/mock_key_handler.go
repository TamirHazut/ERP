...
// Source: erp.localhost/internal/infra/db/redis/handlers (interfaces: KeyHandler)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_key_handler.go -package=mocks erp.localhost/internal/infra/db/redis/handlers KeyHandler
//
