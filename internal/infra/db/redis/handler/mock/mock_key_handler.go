...
// Source: erp.localhost/internal/infra/db/redis/handler (interfaces: KeyHandler)
//
// Generated by this command:
//
//	mockgen -destination=mock/mock_key_handler.go -package=mock erp.localhost/internal/infra/db/redis/handler KeyHandler
//
