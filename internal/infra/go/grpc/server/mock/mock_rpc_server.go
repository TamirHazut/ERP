...
// Source: erp.localhost/infra/grpc/server (interfaces: RPCServer)
//
// Generated by this command:
//
//	mockgen -destination=mock/mock_rpc_server.go -package=mock erp.localhost/infra/grpc/server RPCServer
//
