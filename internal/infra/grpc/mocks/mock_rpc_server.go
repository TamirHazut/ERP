...
// Source: erp.localhost/internal/infra/grpc/ (interfaces: RPCServer)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_rpc_server.go -package=mocks erp.localhost/internal/infra/grpc/ RPCServer
//
