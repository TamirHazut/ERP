...
//go:generate mockgen -destination=mocks/mock_redis_handler.go -package=mocks erp.localhost/internal/db/redis/handlers RedisHandler
//go:generate mockgen -destination=mocks/mock_key_handler.go -package=mocks erp.localhost/internal/db/redis/handlers KeyHandler
//go:generate mockgen -destination=mocks/mock_set_handler.go -package=mocks erp.localhost/internal/db/redis/handlers SetHandler
